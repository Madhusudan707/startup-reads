    ...
    <div>
      ...
      {libraryLoading ? (
        ...
        <div className="mt-24 lg:py-20 mx-5 lg:mx-20 mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 lg:gap-16 py-20">
            <div className="border-2 border-blue-400 rounded-lg p-4 flex flex-col items-center">
              ...
              >
                ...
                ipsum dolor sit ametlorem ipsum dolor sit amet lorem ipsum dolor
