...
export const Widget = () => {
    ...
    return (
        <>
        <div className='flex flex-row lg:flex-col fixed lg:top-24 lg:mt-3 bottom-0 p-2 text-white   bg-blue-400 lg:justify-between justify-around items-center  lg:w-14 w-full lg:h-48 h-16  lg:rounded-lg z-10 '>
