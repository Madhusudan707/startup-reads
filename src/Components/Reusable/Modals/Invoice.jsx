...
export const Invoice = () => {
  ...
  return (
    ...
    >
      <div className=" flex flex-col items-center justify-center border w-full p-8 bg-blue-brand ">
        <Close nameClass="text-white hover:text-red-500 text-3xl no-print" />
        <Heading
          text={languageState.data.invoice || "FAKE INVOICE"}
          nameClass="no-print text-center text-3xl lg:text-4xl text-white mb-5 pt-5"
        />
        <div className="border p-16">
          <div className="flex flex-col w-96 ">
            ...
            <div className="flex flex-row w-96 justify-between text-1xl py-2 border-b">
              <span>
                {languageState.data.thank_you_for_your_order ||
            ...
            <div className="flex flex-row w-96 justify-end text-1xl py-2">
              <span className="px-2">
                {languageState.data.subtotal || "Subtotal"}
              </span>
              <span>
            ...
            <div className="flex flex-row w-96 justify-end text-1xl py-2">
              <span className="px-2">
                {languageState.data.shipping_and_handling ||
                  "SHIPPING & HANDLING"}
              </span>
              <span>
                <i className="fas fa-rupee-sign"></i>
            ...
            <div className="flex flex-row w-96 justify-end text-1xl py-2">
              <span className="px-2">
                {languageState.data.gst || "GST"} (5%)
              </span>
              <span>
                <i className="fas fa-rupee-sign"></i>15
              </span>
            </div>
            <div className="flex flex-row w-96 justify-end text-1xl py-2 border-t border-b">
              <span className="px-2">
                {languageState.data.total || "Total"}
              </span>
              <span>
                <i className="fas fa-rupee-sign"></i>
                {final + 60 + 15}
            ...
            <div className="flex flex-col font-bold py-2">
              <span>
                {languageState.data.billing_information ||
                  "BILLING INFORMATION"}
              </span>
              <span>MADDY</span>
            ...
            <div className="flex justify-center items-center -2 border-t">
              <Button
                text="PRINT"
                nameClass="no-print bg-blue-brand text-white p-4 mt-4 shadow-md text-2xl hover:bg-gray-600"
