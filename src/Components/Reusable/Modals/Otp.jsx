      ...
      <div className="modal-content flex flex-col items-center w-full relative   ">
        ...
        <div className="lg:w-2/5 border w-96  flex flex-col lg:h-3/6  justify-center lg:items-center">
          <div className="flex flex-col items-center justify-center p-2 lg:py-5">
            <div className="lg:w-2/5   flex flex-col lg:h-3/6  justify-center lg:items-center">
              <Heading
                text="Login With OTP"
              ...
              <div className="flex flex-row flex-wrap items-center justify-center">
                ...
                />
                <Button
                  nameClass="bg-blue-brand p-2 mt-2  w-20 self-center text mb-5 text-white self-end rounded-lg"
                  text="Get OTP"
                  btnFunction={getOtp}
                />
              ...
              <Button
                nameClass="bg-blue-brand p-2  w-72 self-center text-2xl mb-5 text-white rounded-lg"
                text="Login"
              />
